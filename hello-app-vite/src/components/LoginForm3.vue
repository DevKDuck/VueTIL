...
const onsubmit = (event) => {
  if (loginData.pwd !== loginData.pwd2) {
  ...
  console.log("uid", loginData.uid);
  console.log("pwd", loginData.pwd);
  console.log("name", loginData.name);
  console.log("gender", loginData.gender);
  console.log("selected_hobby", loginData.selected_hobby);
  console.log("birth_day", loginData.birth_day);
  ...
  <div>
    <form @submit.prevent="onsubmit">
      ...
      <div>
        ...
        <div v-for="hobby in hobbies" :key="hobby.hobby_id">
          <input
            type="checkbox"
            :id="hobby.hobby_id"
            v-model="loginData.selected_hobby"
      ...
      <div>
        ...
        <input type="date" id="birth_day" v-model="loginData.birth_day" required />
      </div>
      <div>
